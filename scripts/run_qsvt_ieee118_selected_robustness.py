...
from robust_qsvt_se.qsvt.ieee118_selected_robustness import (  # noqa: E402
    DEFAULT_ALPHAS,
    DEFAULT_DEGREES,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="IEEE118 selected (4x4) subproblem robustness for the co-designed QSVT solver."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/qsvt_ieee118_selected_robustness")
...
def main() -> None:
    ...
    run = run_qsvt_ieee118_selected_robustness(config)
    rows = run["rows"]
    ...
    print(f"Wrote IEEE118 selected robustness to {run['output_dir']}")
